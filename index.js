 ...
 * Homepage: https://shopilo.it/negozi/auto-doc.it
 */

const SHOPILO_URL = "https://shopilo.it/negozi/auto-doc.it";
const STORE_NAME  = "Autodoc";

async function fetchCoupons(url = SHOPILO_URL) {
  const res = await fetch(url, {
    headers: { "User-Agent": "coupon-fetcher/1.0 (+https://github.com/shopilo-it/codice-sconto-autodoc)" }
  });
