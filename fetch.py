#!/usr/bin/env python3
"""
Recupero codici sconto Autodoc da shopilo.it
Sursa: https://shopilo.it/negozi/auto-doc.it
"""
...
SHOPILO_URL = "https://shopilo.it/negozi/auto-doc.it"
STORE_NAME = "Autodoc"


def fetch_coupons(url=SHOPILO_URL):
    """Restituisce la lista dei coupon attivi per Autodoc da shopilo.it"""
    headers = {
        "User-Agent": "Mozilla/5.0 (compatible; coupon-fetcher/1.0; +https://github.com/shopilo-it/codice-sconto-autodoc)"
    }
    try:
